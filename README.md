...
#### Video Link
예시 비교 영상
| Proposed (Modular PPO) | Baseline (End-to-End PPO) |
|-------------------------|---------------------------|
| <img src="docs/modular_demo.gif" width="400"> | <img src="docs/end_to_end_demo.gif" width="400"> 

https://youtu.be/ltiINKhbP2Q
...
The full capstone report is available below.
